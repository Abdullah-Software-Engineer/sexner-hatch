        ...
        <Container className="px-6 sm:px-10 md:px-12 lg:px-16">
          <div className="max-w-2xl pl-4 sm:pl-6 md:pl-8 lg:pl-10">
            ...
            <div className="flex flex-col gap-5">
              <p className="font-poppins text-white text-[16px] md:text-[16px] lg:text-[16px] xl:text-[18px] leading-relaxed drop-shadow-md text-left">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do do do
              </p>
