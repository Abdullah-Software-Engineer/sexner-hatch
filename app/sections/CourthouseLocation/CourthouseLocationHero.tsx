        ...
        <Container className="px-6 sm:px-10 md:px-12 lg:px-16">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 lg:gap-20">
            ...
            <div className="lg:w-1/2 pl-4 sm:pl-6 md:pl-8 lg:pl-10">
              <h1 
                className="font-playfair font-medium text-white text-[30px] md:text-[30px] lg:text-[48px] xl:text-[48px]"
            ...
            <div className="lg:w-1/2 flex flex-col items-start gap-8 pl-4 sm:pl-6 md:pl-8 lg:pl-10">
              <p className="font-poppins text-white text-[16px] md:text-[16px] lg:text-[16px] xl:text-[18px] leading-relaxed max-w-xl">
              ...
              >
                <span className="text-[14px] md:text-[14px] lg:text-[14px] xl:text-[16px] font-medium tracking-wide">Contact us today</span>
