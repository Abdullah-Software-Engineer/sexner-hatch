    ...
    <section className="relative min-h-[70vh] overflow-hidden flex items-center">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-primary/70 z-1" aria-hidden="true" />
      </div>
      ...
      <div className="relative z-10 w-full pt-20 pb-16 md:pt-28 md:pb-24">
        <Container className="px-6 sm:px-10 md:px-12 lg:px-16">
          <div className="max-w-2xl pl-4 sm:pl-6 md:pl-8 lg:pl-10">
            ...
            >
              TERMS &amp;{' '}
              <span className="text-secondary" style={{ fontFamily: 'var(--font-playfair), serif' }}>CONDITIONS</span>
            </h1>
